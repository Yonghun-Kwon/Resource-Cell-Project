...
#
#  C를 등비수열, H를 역비례 조정 → spatial 준고정, OI 단조 증가
# ─────────────────────────────────────────────
CONV_CONFIGS = [
    # (B, Cin, Cout,  H,   W,  K)
    (1,  16,  32,  56,  56,  3),   # step1  OI≈ 8.7  mem≈2.7 MB
    (1,  24,  48,  44,  44,  3),   # step2  OI≈12.8  mem≈2.5 MB
    (1,  32,  64,  40,  40,  3),   # step3  OI≈16.8  mem≈2.7 MB
    (1,  48,  96,  32,  32,  3),   # step4  OI≈23.5  mem≈2.8 MB
    (1,  64, 128,  28,  28,  3),   # step5  OI≈28.7  mem≈3.1 MB
    (1,  96, 192,  28,  28,  3),   # step6  OI≈39.2  mem≈5.1 MB
    (1, 128, 256,  28,  28,  3),   # step7  OI≈47.9  mem≈7.4 MB
    (1, 192, 384,  28,  28,  3),   # step8  OI≈61.7  mem≈13.0 MB
    #  Δlog₁₀(OI): 0.17, 0.12, 0.15, 0.09, 0.13, 0.09, 0.11  (균등)
]
...
#
#  트레이드오프:
#    H = round(√(16·64²/C)/4)·4 → spatial(C·H²) = 16·64² 준고정
#    → mem이 스텝 간 거의 일정(≈1.2~1.4 MB) 유지
#    H 하한 = 16 (너무 작으면 overhead 지배)
# ─────────────────────────────────────────────
DPE_CONFIGS = [
    # (B,  C,   H,   W,  K)
    (1,  16,  64,  64,  3),   # step1  OI≈2.75  mem≈1.31 MB
    (1,  24,  52,  52,  3),   # step2  OI≈3.54  mem≈1.30 MB
    (1,  32,  44,  44,  3),   # step3  OI≈4.33  mem≈1.24 MB
    (1,  48,  36,  36,  3),   # step4  OI≈5.90  mem≈1.26 MB
    (1,  72,  28,  28,  3),   # step5  OI≈8.20  mem≈1.15 MB
    (1, 104,  24,  24,  3),   # step6  OI≈11.1  mem≈1.25 MB
    (1, 152,  20,  20,  3),   # step7  OI≈15.4  mem≈1.31 MB
    (1, 224,  16,  16,  3),   # step8  OI≈21.1  mem≈1.36 MB
    #  Δlog₁₀(OI): 0.11, 0.09, 0.13, 0.14, 0.13, 0.13, 0.12  (균등)
    #  mem 변동: ±0.1 MB (거의 일정) ← 트레이드오프의 이상적 해
]
